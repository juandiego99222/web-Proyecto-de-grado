...
from .views import ProyectoArchivosDetailView, ProyectoListView,ProyectoDetailView,ProyectoCreate,ProyectoUpdate,ProyectoDelete, ProyectoRecursosDetailView,  ScheduleDetailView,ArchivoCreate
